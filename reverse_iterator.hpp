...
/*   Updated: 2022/04/22 18:46:44 by lgaudet-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft{
	template<class Iter> class reverse_iterator {
		public:
			...
			friend inline difference_type operator-(const reverse_iterator& lhs, const reverse_iterator& rhs )  {return rhs.base() -lhs.base();}
